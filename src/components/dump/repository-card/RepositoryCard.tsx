...
export const RepositoryCard = ({
    ...
    return <div  className="card bg-base-200 h-full shadow-xl hover:shadow-sm">
...
const forkIcon = <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    viewBox="0 0 24 24">
        <path fill-rule="evenodd" d="M12 21a1.75 1.75 0 110-3.5 1.75 1.75 0 010 
        ...
        <path fill-rule="evenodd" d="M6.5 7.75v1A2.25 2.25 0 008.75 11h6.5a2.25 2.25 0 
